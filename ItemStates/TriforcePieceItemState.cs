...
{
    internal class TriforcePieceItemState : IJustItemState
    {
        private Item item;
        public TriforcePieceItemState(Item item)
        {
            this.item = item;
            item.ItemSprite = ItemSpriteFactory.Instance.CreateTriforcePieceItem();
        }

...
{
    internal class HeartContainerItemState : IJustItemState
    {
        private Item item;
        public HeartContainerItemState(Item item)
        {
            this.item = item;
            item.ItemSprite = ItemSpriteFactory.Instance.CreateHeartContainerItem();
        }

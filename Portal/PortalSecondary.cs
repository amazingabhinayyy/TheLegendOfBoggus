...
namespace Sprint2_Attempt3.Portal
{
    public class PortalSecondary : IPortal
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 change)
        {
            ...
            Rectangle destinationRectangle = new Rectangle(50, 50, 50, 30);
            //Rectangle destinationRectangle = new Rectangle(position.X + (int)(change.X * 3.125), position.Y + (int)(change.Y * 3.125), 50, 30);
        ...
        {
            return new Rectangle(position.X, position.Y, position.Width, position.Height / 4);
        }
    }
}

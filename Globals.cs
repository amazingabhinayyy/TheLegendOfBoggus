...
namespace Sprint2_Attempt3
{
    internal class Globals
    {
        ...
        {
            {1, new Rectangle(100, 300, 50, 50) },
            {2, new Rectangle(150, 300, 50, 50) },
            {3, new Rectangle(200, 300, 50, 50) },
            {4, new Rectangle(250, 300, 50, 50) },
            {5, new Rectangle(300, 300, 50, 50) },
            {6, new Rectangle(350, 300, 50, 50) },
            {7, new Rectangle(400, 300, 50, 50) },
            {8, new Rectangle(450, 300, 50, 50) },
            {9, new Rectangle(500, 300, 50, 50) },
            {10, new Rectangle(550, 300, 50, 50) },
            {11, new Rectangle(600, 300, 50, 50) },
            {12, new Rectangle(650, 300, 50, 50) },

            {13, new Rectangle(100, 350, 50, 50) },
            {14, new Rectangle(150, 350, 50, 50) },
            {15, new Rectangle(200, 350, 50, 50) },
            {16, new Rectangle(250, 350, 50, 50) },
            {17, new Rectangle(300, 350, 50, 50) },
            {18, new Rectangle(350, 350, 50, 50) },
            {19, new Rectangle(400, 350, 50, 50) },
            {20, new Rectangle(450, 350, 50, 50) },
            {21, new Rectangle(500, 350, 50, 50) },
            {22, new Rectangle(550, 350, 50, 50) },
            {23, new Rectangle(600, 350, 50, 50) },
            {24, new Rectangle(650, 350, 50, 50) },

            {25, new Rectangle(100, 400, 50, 50) },
            {26, new Rectangle(150, 400, 50, 50) },
            {27, new Rectangle(200, 400, 50, 50) },
            {28, new Rectangle(250, 400, 50, 50) },
            {29, new Rectangle(300, 400, 50, 50) },
            {30, new Rectangle(350, 400, 50, 50) },
            {31, new Rectangle(400, 400, 50, 50) },
            {32, new Rectangle(450, 400, 50, 50) },
            {33, new Rectangle(500, 400, 50, 50) },
            {34, new Rectangle(550, 400, 50, 50) },
            {35, new Rectangle(600, 400, 50, 50) },
            {36, new Rectangle(650, 400, 50, 50) },

            {37, new Rectangle(100, 450, 50, 50) },
            {38, new Rectangle(150, 450, 50, 50) },
            {39, new Rectangle(200, 450, 50, 50) },
            {40, new Rectangle(250, 450, 50, 50) },
            {41, new Rectangle(300, 450, 50, 50) },
            {42, new Rectangle(350, 450, 50, 50) },
            {43, new Rectangle(400, 450, 50, 50) },
            {44, new Rectangle(450, 450, 50, 50) },
            {45, new Rectangle(500, 450, 50, 50) },
            {46, new Rectangle(550, 450, 50, 50) },
            {47, new Rectangle(600, 450, 50, 50) },
            {48, new Rectangle(650, 450, 50, 50) },

            {49, new Rectangle(100, 500, 50, 50) },
            {50, new Rectangle(150, 500, 50, 50) },
            {51, new Rectangle(200, 500, 50, 50) },
            {52, new Rectangle(250, 500, 50, 50) },
            {53, new Rectangle(300, 500, 50, 50) },
            {54, new Rectangle(350, 500, 50, 50) },
            {55, new Rectangle(400, 500, 50, 50) },
            {56, new Rectangle(450, 500, 50, 50) },
            {57, new Rectangle(500, 500, 50, 50) },
            {58, new Rectangle(550, 500, 50, 50) },
            {59, new Rectangle(600, 500, 50, 50) },
            {60, new Rectangle(650, 500, 50, 50) },

            {61, new Rectangle(100, 550, 50, 50) },
            {62, new Rectangle(150, 550, 50, 50) },
            {63, new Rectangle(200, 550, 50, 50) },
            {64, new Rectangle(250, 550, 50, 50) },
            {65, new Rectangle(300, 550, 50, 50) },
            {66, new Rectangle(350, 550, 50, 50) },
            {67, new Rectangle(400, 550, 50, 50) },
            {68, new Rectangle(450, 550, 50, 50) },
            {69, new Rectangle(500, 550, 50, 50) },
            {70, new Rectangle(550, 550, 50, 50) },
            {71, new Rectangle(600, 550, 50, 50) },
            {72, new Rectangle(650, 550, 50, 50) },

            {73, new Rectangle(100, 600, 50, 50) },
            {74, new Rectangle(150, 600, 50, 50) },
            {75, new Rectangle(200, 600, 50, 50) },
            {76, new Rectangle(250, 600, 50, 50) },
            {77, new Rectangle(300, 600, 50, 50) },
            {78, new Rectangle(350, 600, 50, 50) },
            {79, new Rectangle(400, 600, 50, 50) },
            {80, new Rectangle(450, 600, 50, 50) },
            {81, new Rectangle(500, 600, 50, 50) },
            {82, new Rectangle(550, 600, 50, 50) },
            {83, new Rectangle(600, 600, 50, 50) },
            {84, new Rectangle(650, 600, 50, 50) }
        };
        ...
        public static Rectangle NorthDoorPosition { get { return new Rectangle(348,200, 105, 100); } }
        public static Rectangle SouthDoorPosition { get { return new Rectangle(348, 650, 105, 100); } }
        public static Rectangle EastDoorPosition { get { return new Rectangle(700, 427, 100, 94); } }
        public static Rectangle WestDoorPosition { get { return new Rectangle(0, 427, 100, 94); } }

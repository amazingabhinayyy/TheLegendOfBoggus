...
{
    public class GanonTransitionHandler : ITransitionHandler
    {
       ...
       private static GanonTransitionHandler instance = new GanonTransitionHandler();
        public static GanonTransitionHandler Instance
        {
            get{ return instance; }
        }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (colorValue >= 255)
            {
                this.game1.gameState = Game1.GameState.startScreen;
            }
        }
        public void Update()
        {

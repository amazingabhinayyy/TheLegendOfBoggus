...
namespace Sprint2_Attempt3.Dungeon
{
    public class RandomRoomSpriteCreator
    {
        ...
        private readonly string[] sepcialPreset5 = { "Block,BlueTile,1", "Block,BlueTile,2", "Block,BlueTile,3", "Block,BlueTile,13", "Block,BlueTile,14", "Block,BlueTile,26", "Block,BlueTile,38", "Block,BlueTile,50", "Block,BlueTile,61", "Block,BlueTile,62", "Block,BlueTile,73", "Block,BlueTile,74", "Block,BlueTile,63", "Block,BlueTile,64", "Block,BlueTile,75", "Block,BlueTile,76", "Block,BlueTile,17", "Block,BlueTile,28", "Block,BlueTile,29", "Block,BlueTile,40", "Block,BlueTile,41", "Block,BlueTile,20", "Block,BlueTile,32", "Block,BlueTile,33", "Block,BlueTile,44", "Block,BlueTile,45", "Block,BlueTile,54", "Block,BlueTile,55", "Block,BlueTile,10", "Block,BlueTile,11", "Block,BlueTile,12", "Block,BlueTile,23", "Block,BlueTile,24", "Block,BlueTile,35", "Block,BlueTile,47", "Block,BlueTile,59", "Block,BlueTile,69", "Block,BlueTile,70", "Block,BlueTile,71", "Block,BlueTile,72", "Block,BlueTile,81", "Block,BlueTile,82", "Block,BlueTile,83", "Block,BlueTile,84" };
        ...
        private readonly string[] normalPreset9 = { "Block,DiamondTile,15", "Block,DiamondTile,10", "Block,DiamondTile,22", "Block,DiamondTile,63", "Block,DiamondTile,75", "Block,DiamondTile,70" };
